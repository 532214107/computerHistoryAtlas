...
export default {
  ...
  methods: {
    init () {
     ...
     const nodes = node.map((node, index) => {
      ...
      this.$nextTick(() => {
        ...
        // this.importNetwork(container, data, options)
        ...
        network.once('stabilizationIterationsDone', () => {
          ...
          // this.randomNodeInterval = setInterval(() => {
          //   if (focusRandomNodeIndex > 5) {
          //     focusRandomNodeIndex = 0
          //   }
          //   this.focusRandom(focusRandomNodes[focusRandomNodeIndex++])
          // }, 2000)
    ...
    importNetwork (container, data, options) {
      const _data = {
        nodes: this.getNodeData(exportArea),
        edges: this.getEdgeData(exportArea)
      }
      network = new Network(container, _data, options)
    },
    exportNetwork () {
